...
public class GetArticleData {
    ...
    public static class DatasBean {
         ...
         * fresh : false
         * id : 10864
         * link : https://blog.csdn.net/a1018875550/article/details/103533668
         * niceDate : 2019-12-13 22:50
         * niceShareDate : 2019-12-13 22:50
         * origin :
         * prefix :
         * projectLink :
         * publishTime : 1576248611000
         * selfVisible : 0
         * shareDate : 1576248611000
         * shareUser : jokar
         * superChapterId : 494
         * superChapterName : 广场Tab
         * tags : []
         * title : 这可能是最好用、实现最简单的Android权限请求库了
         * type : 0
         * userId : 35905
         * visible : 1
         * zan : 0
